...
class PoJie():
    ...
    def readPassWord(self):
        ...
        while True:
            try:
                myStr = self.file.readline() #一行一行读取
                myStr = myStr.strip()
                print("密码:",myStr)
                length=8
                if len(myStr) < length:
...
# 密码字典需在网上下载
path = r"/home/centyuan/PycharmProjects/py_test/tempfile/weak_password"
start = PoJie(path)
start.readPassWord()
