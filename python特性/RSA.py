...
import base64
public_key_path = r"D:\BaiduNetdiskDownload\python-demo\tempfile\rsa_public_key.pem"
private_key_path = r"D:\BaiduNetdiskDownload\python-demo\tempfile\rsa_private_key.pem"
...
def generate_key():
    ...
    with open(r'D:\BaiduNetdiskDownload\python-demo\tempfile\rsa_private_key.pem', 'wb')as f:
        f.write(private_key)

    with open(r'D:\BaiduNetdiskDownload\python-demo\tempfile\rsa_public_key.pem', 'wb')as f:
        f.write(public_key)
