...
# 类的多重继承的继承顺序(深度优先,广度优先)
"""
python2.x中都是经典类,显示继承object才是新式类
python3.x中默认都是新式类,不必显示继承object

1.经典类:采用深度优先(按继承循序将每一个最深找完)
2.新式类:采用广度优先(按继承顺序将第一层找完)

查看解析顺序可以看MRO(Method Resolution Order)
print(class_obj.__mro__)
"""