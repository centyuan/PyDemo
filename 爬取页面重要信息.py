...
# 实例之匹配电话号码
strs = 'dsadasdgs031-1564653233adads2312-24644567dZDxz 《18382972834》 《《《《 15808939049'
pat = '\d{3}-\d{8}|\d{4}-\d{7}'
print('电话匹配')
print(re.compile(pat).findall(strs))
pattern = re.compile(r'0?(13|14|15|17|18)[0-9]{9}')
...
# res = requests.get("https://www.mute.design/search/432bet444.com%E3%80%90TG%E7%94%B5%E6%8A%A5%E2%88%B6@AK5537%E3%80%91google%E7%AB%99%E7%BE%A4%EF%BC%8Cgoogle%E5%8D%9A%E5%BD%A9%E5%BC%95%E7%B2%89%E3%80%91%E8%8A%AC%E5%85%B0%E8%B0%B7%E6%AD%8C%E9%9C%B8%E5%B1%8F%E6%8E%A8%E5%B9%BF%E6%8E%92%E5%90%8D%E3%80%90telegram%E2%88%B6@AK5537%E3%80%91%E8%B0%B7%E6%AD%8Cseo%E4%BC%98%E5%8C%96%E6%8E%A8%E5%B9%BF%E9%9D%A0%E8%B0%B1%E3%80%9172e%E4%BB%94kmc",headers=headers,verify=False)
res = requests.get("http://china.qianlong.com/2020/0831/4654565.shtml",headers=headers,verify=False)
print(res.text)
...
pat_3 = r'(13\d{9}|14[5|7]\d{8}|15\d{9}|166{\d{8}|17[3|6|7]{\d{8}|18\d{9})'
print('电话匹配')
