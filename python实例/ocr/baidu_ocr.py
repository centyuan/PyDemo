...
def baidu_sdk(app_id, api_key, secret_key, file_path=None, file_url=None):
    """
    百度ocr sdk pip install baidu-aip
    :param app_id:
    :param api_key:
    :param secret_key:
    :param file_path:
    ...
    if file_path:
        with open(file_path, 'rb') as f:
            ...
            res_image = baidu_client.basicGeneral(image, options={'language_type': 'CHN_ENG'})
            return res_image
    elif file_url:
        res_url = baidu_client.basicGeneralUrl(file_url, options={'language_type': 'CHN_ENG'})
        return res_url


if __name__ == '__main__':
    app_id = '27946505'
    api_key = '2wLsHOfQdiwOj3H5g7zYHkL'  # AK
    secret_key = 'km63Ddnj2FWtFwmWkmDW0EQOjZW455AH'  # Sk
